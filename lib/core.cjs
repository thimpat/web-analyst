...
const {get24HoursLabels, getTodayDate, getWeekLabel, getYearLabels, getYearFilename} = require("./common.cjs");
 ...
 * @returns {boolean|*[]}
 */
const updateVisitorsJsonFiles = function ()
{
    try
    {
...
module.exports.updateVisitorsJsonFiles = updateVisitorsJsonFiles;
