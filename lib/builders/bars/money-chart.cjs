...
const {CHART_DATA_FILES, CHART_TYPE} = require("../../../hybrid/cjs/constants.cjs");
const {parseNow} = require("../../line-manager.cjs");
const {getEarningPattern} = require("../../utils/patterns.cjs");
const {getWeekLabels, getYearLabels} = require("../../../hybrid/cjs/fixed-label-generator.cjs");
...
const createEarningEmptyChart = (jsonPath) =>
{
    try
    {
        ...
        json.days = new Array(week.length).fill(0);
    ...
    {
        console.error({lid: 2485}, e.message);
    }
