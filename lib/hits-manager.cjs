...
const {addToIpFile, buildIpFile, updateIPFile} = require("./ips.cjs");

const {registerTodayChart, saveTodayFile, updateTodayContent} = require("./entities/today-chart.cjs");
const {registerWeekChart, saveWeekFile, updateWeekContent} = require("./entities/week-chart.cjs");
const {registerYearChart, saveYearFile, updateYearContent} = require("./entities/year-chart.cjs");
 ...
 * @returns {boolean|*[]}
 */
const updateDataFiles = function ()
{
    try
    {
