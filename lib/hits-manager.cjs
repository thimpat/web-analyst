...
const {generateTodayChartData, saveTodayFile, updateTodayContent} = require("./entities/bars/today-chart.cjs");
const {generateWeekChartData, saveWeekFile, updateWeekContent} = require("./entities/bars/week-chart.cjs");
const {generateYearChartData, saveYearFile, updateYearContent} = require("./entities/bars/year-chart.cjs");
const {generateBrowserPopularityChartData, saveBrowserPopularityFile} = require("./entities/pies/browsers-charts.cjs");
